...
const cards = [
    {
        ...
        description: "Book a table hassle-free and enjoy a delightful dining experience at your favorite restaurant.",
        button: "Book"
    },
    {
        id: 2,
        ...
        img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQuv61hLzhnhnwgF1JgMWQH7J2e0O3vrJkXpQ&s",
        description: "Limited time offer! Get a discount on your next table booking when you sign up today.",
        button: "Sign up"
    },
    {
        id: 3,
                                ...
                                <div className="card text-center shadow-lg p-3 rounded-4">
                                    <div className="card-body">
                                        <div className="position-relative">
                                            <img src={card.img} alt="restaurant" className="w-100 rounded-3" />
                                            {card.tag && (
                                        ...
                                        <LinkR to="/bookings" className="btn btn-danger px-4 mt-5 rounded rounded-5 fs-3 fw-light">
                                            {card.button}
                                        </LinkR>
                                    </div>
                                </div>

  ...
  const confirmSave = async () => {
    try {
      ...
      const response = await axios.put(
        `${process.env.REACT_APP_API_URL}/owners/:owner_id/restaurants/${restaurant_id}/tables/${table.id}`,
        formData,
        ...
        <div className="card-body table-card-body">
          ...
          <div className="d-flex justify-content-around align-items-center">
            <p className="text-muted">
              🪑 Seats:{" "}
              <span className="fw-semibold">{table.seats || "N/A"}</span>
            </p>
            <p className="text-muted">
              Type: <span className="fw-semibold">{table.type}</span>
            </p>
          </div>
          <p className="small">
          ...
          <div className="modal-dialog modal-dialog-centered">
            <div className="modal-content rounded-4 shadow-lg border-0">
              ...
              <div className="modal-body p-4 bg-white">
                ...
                <ul>
                  <li>
                    <strong>Table Name:</strong> {formData.name}
                  </li>
                  <li>

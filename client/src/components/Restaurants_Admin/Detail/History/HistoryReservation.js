...
const ReservationList = ({ restaurant_id }) => {
    ...
    const fetch = useCallback(() => {
        try {
            axios
                .get(`http://localhost:8080/admin/restaurants/${restaurant_id}/reservations`, { withCredentials: true })
                .then((res) => {
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        axios
            .post(`http://localhost:8080/admin/restaurants/${restaurant_id}/reservations/edit`, finish, { withCredentials: true })
            .then(() => {

...
export default function StaffList({ restaurant_id }) {
    ...
    const fetchStaff = useCallback(() => {
        axios.get(`http://localhost:8080/admin/restaurants/${restaurant_id}/staffs`, { withCredentials: true })
            .then((res) => {
    ...
    const handleConfirmToggle = async () => {
        ...
        try {
            await axios.post(
                `http://localhost:8080/admin/restaurants/${restaurant_id}/staffs/${id}`,
                { Status: status, Id: id },

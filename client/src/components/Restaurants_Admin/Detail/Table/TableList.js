...
const TableList = ({ restaurant_id }) => {
  ...
  const fetchTables = useCallback(async () => {
    try {
      axios.get(`http://localhost:8080/admin/restaurants/${restaurant_id}/tables`, { withCredentials: true })
  ...
  useEffect(() => {
    axios.get(`http://localhost:8080/admin/restaurants/${restaurant_id}`, { withCredentials: true })
      .then((res) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.put(`http://localhost:8080/admin/restaurants/${restaurant_id}`, formData, { withCredentials: true })
        .then(() => {
  ...
  const handleDeleteRestaurant = () => {
    axios.post(`http://localhost:8080/admin/restaurants/${restaurant_id}`, {}, { withCredentials: true, })
      .then(() => {

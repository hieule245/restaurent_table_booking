...
const ReservationList = () => {
    ...
    const fetch = () => {
        try {
            axios
                .get(`http://localhost:8080/staff/:restaurant_id/reservation`, { withCredentials: true })
                .then((res) => {
    ...
    const handleUpdate = (e) => {
        e.preventDefault();
        axios
            .post(`http://localhost:8080/staff/:restaurant_id/reservation/finish_booking`, finish, { withCredentials: true })
            .then(() => {
    ...
    return (
        <div className="mt-5">
            <div className="container mt-5">
                <ToastContainer />
                <h2 className="text-center mb-2 mt-5" style={{ color: "#dc3545" }}>Reservation List</h2>
